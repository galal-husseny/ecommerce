                                            ...
                                            <div class="col-3">
                                                ...
                                                <select name="model_id" class="custom-select" id="model_id">
                                                    @foreach ($models as $model)
                                                        <option @selected(old('model_id') == $model->id) value="{{ $model->id }}">
                                                    ...
                                                    <div data-repeater-item class="my-3">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3">
                                                                ...
                                                                <input type="text" name="en" class="form-control specValue"
                                                                    id="text">
                                                            </div>
                                                            <div class="col-3">
                                                                <label for="text"> القيمة باللغة العربية</label>
                                                                <input type="text" name="ar" class="form-control specValue"
                                                                    id="text">
                                                            </div>
                                                ...
                                                <div data-repeater-item>
                                                    <div class="row mb-20">
                                                        <div class="col-md-3">
                                                            ...
                                                            <img name="image" src="{{ asset('assets/admin/images/default.png') }}" class="w-100" style="cursor: pointer" alt="صورة المنتج">
                                                            {{-- </label> --}}
                                                            <input type="file" class="custom-file-input d-none"
                                                                id="customFile" name="image" onchange="previewImage(event)" />
                                                        </div>
                                                        <div class="col-md-2">
