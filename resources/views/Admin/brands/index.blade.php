                ...
                <tbody>
                    @forelse ($brands as  $brand)
                        <tr>
                            ...
                            <td><label
                                    class="badge badge-{{ $brand->status == 1 ? 'success' : 'danger' }}">{{ $brand->status == 1 ? 'مفعل' : 'غير مفعل' }}</label>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="alert alert-warning font-weight-bold text-center w-100">لايوجد علامات
                                تجارية
                                حاليا</td>
                        </tr>
                    @endforelse
